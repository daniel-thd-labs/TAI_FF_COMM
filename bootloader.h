...
#define DO_RESET	0x09

#define STOP_PASSTRUE		0x10	//implicite...
#define START_PASSTRUE1		0x11	//SERIAL IN EIA485 OUT
#define START_PASSTRUE2		0x12	//
#define START_PASSTRUE3		0x13	//
#define START_PASSTRUE4		0x14	//
#define START_PASSTRUE5		0x15	//
#define START_PASSTRUE6		0x16	//
...
void BLmain(void) __attribute__((section("BootloaderSection"),address(0x400)));
void IoInit(void) __attribute__((section("BootloaderSection")));
void UartInit(void) __attribute__((section("BootloaderSection")));
void TimerInit(void) __attribute__((section("BootloaderSection")));
DWORD ReadLatch(WORD, WORD) __attribute__((section("BootloaderSection")));
void ResetCMD(void) __attribute__((section("BootloaderSection")));
void Erase(WORD, WORD, WORD) __attribute__((section("BootloaderSection")));
void WriteLatch(WORD, WORD, WORD, WORD) __attribute__((section("BootloaderSection")));
void WriteMem(WORD) __attribute__((section("BootloaderSection")));
void ResetDevice(WORD) __attribute__((section("BootloaderSection")));
void PutChar(BYTE) __attribute__((section("BootloaderSection")));
void GetChar(BYTE *) __attribute__((section("BootloaderSection")));
void ReadPM(WORD, DWORD_VAL) __attribute__((section("BootloaderSection")));
void WritePM(WORD, DWORD_VAL) __attribute__((section("BootloaderSection")));
void ErasePM(WORD, DWORD_VAL) __attribute__((section("BootloaderSection")));
void WriteTimeout() __attribute__((section("BootloaderSection")));
void GetCommand() __attribute__((section("BootloaderSection")));
int HandleCommand() __attribute__((section("BootloaderSection")));
void PutResponse(WORD) __attribute__((section("BootloaderSection1")/*test ,address(0xa00)*/));
//void AutoBaud() __attribute__((section("BootloaderSection"),address(0xa00)));
