...
/** INCLUDES *******************************************************/
//#include "SCV_MASTER_declaration_variables_et_entetes.h"
#include "usb.h"
//#include "./HardwareProfile - PIC24F 28_Pin Starter Board.h"
#define self_power          1
...
#include "usb_device_local.h"
    ...
    #include "./include/usb/usb_function_msd.h"
#endif
...
//#if !defined(USB_USER_DEVICE_DESCRIPTOR1a)
//    extern ROM USB_DEVICE_DESCRIPTOR device_dsc1;
//#endif
...
//   extern ROM BYTE *ROM USB_CD_Ptr1a[];
...
//extern ROM BYTE *ROM USB_SD_Ptr1a[];
 ...
 *                  request.
 *
 * Note:            version oriniale fonctionnelle en 1_5
 *******************************************************************/
static void USBStdGetDscHandler(void)
{
...
unsigned char a;
if(get_midi_quant(TX_BUFFER))
	{
	if(!USBHandleBusy(USBTxHandle))
		{
		Buffer_To_Usbmidi(TX_BUFFER);
